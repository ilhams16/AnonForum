...
Public Interface IComment
    ...
    Function GetUserLike(commentID As Integer, postID As Integer) As IEnumerable(Of Integer)
    Function GetUserDislike(commentID As Integer, postID As Integer) As IEnumerable(Of Integer)
End Interface
